<?php
  ...
  use \PDO;
  /**
   * la class Mysql permet de connecter à la base de donnes Mysql
   * @var $pdo Object instance de type PDO
   * @var $dbConfig Array englobe les variables de aux drivers du Mysql
   */
  class Mysql implements DbDrivers {

    protected $pdo = NULL;
    protected $dbConfig = array();

    /**
     * essayer de connecter à la base de donnee sinon afficher les erreurs
     */
    function __construct() {
      $this->dbConfig = require ROOT . "/Config/DbConfig.php";
      try {
        $this->pdo = new PDO("mysql:host={$this->dbConfig['host']};dbname={$this->dbConfig['dbname']}", $this->dbConfig['user'], $this->dbConfig['password']);
